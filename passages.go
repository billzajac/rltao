// Package rltao provides data from R.L. Wing's Tao of Power.
package rltao
...
func GetPassage(id int) Passage {
	...
	But each cycle merges with the source.<br>
	...
	<br>
	Therefore a good person is the teacher of an inferior person;<br>
	And an inferior person is the resource of a good person.<br>
	...
	The yielding can triumph over the inflexible;<br>
	...
	<br>
	Indeed, the high-placed stem from the humble;<br>
	...
	To respect the Tao and value its Power -<br>
	...
	Good can revert to the abnormal;<br>
